...
public class PhoneBookFrame extends JFrame {
	...
	PhoneBookController controller = new PhoneBookController(this, inputDialog);
	...
	InputDialog dialog = new InputDialog("입력");
	
	class InputDialog extends JDialog {
		InputDialog(String title) {
			super(PhoneBookFrame.this, title, true);
	...
	private void setListener() {
		...
		for(int i = 0; i < mItems.length; i++) {
			mItems[i].addActionListener(controller);
		}
	}	
